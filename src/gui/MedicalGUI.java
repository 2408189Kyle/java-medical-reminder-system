...
public class MedicalGUI extends JFrame {
    ...
    private static final Color BACKGROUND_GRAY = new Color(236, 240, 241); 
    ...
    private void showPatientRegistration() {
        ...
        registrationPanel.setBackground(BACKGROUND_GRAY); 
    ...
    private JPanel createSidePanel() {
        ...
        JButton exitButton = createDangerButton("Exit Application"); // Changed to danger style for visibility
    ...
    private JPanel createStatCard(String label, String value, Color color) {
        ...
        card.setBorder(new CompoundBorder(
            BorderFactory.createMatteBorder(0, 0, 5, 0, color), 
    ...
    private JPanel createCalculateUsagePanel() {
        ...
        // --- START FIX: INCREASED SIZE AND MADE IT MONOSPACED FOR BETTER ALIGNMENT ---
        JTextArea resultArea = new JTextArea(12, 40); 
        resultArea.setEditable(false);
        resultArea.setFont(new Font("Monospaced", Font.PLAIN, 16)); // Slightly larger font
        ...
        resultScroll.setPreferredSize(new Dimension(550, 250)); // Fixed larger size for calculation output
        resultScroll.setBorder(new LineBorder(PRIMARY_BLUE, 1));
        // --- END FIX ---
        ...
        calculateButton.addActionListener(e -> {
            ...
            try {
                ...
                if (duration <= 0) {
                    ...
                    duration = Long.parseLong(daysField.getText().trim());
                    if (duration <= 0) {
                        showError("Days to calculate must be positive.");
                        return;
                    }
                }
                ...
                if (dosesPerDay == 0) {
                     showError("Cannot calculate. Check frequency (e.g., '8 hours' or '1 day').");
                     return;
                }
        ...
        formPanel.add(resultScroll, gbc); // Use the scroll pane
    ...
    private JPanel createViewDetailsPanel() {
        ...
        detailsArea.setBorder(new EmptyBorder(25, 25, 25, 25)); 

...
*The Medical Reminder System features a modern, user-friendly GUI built with Java Swing*

</div>

---

### 🖥️ GUI Component Breakdown

#### **1. Main Interface - Add Prescription Screen**

<div align="center">

![Add Prescription](https://github.com/user-attachments/assets/35b3f5ee-7477-4995-a5af-7e184661ee47)

</div>

<table>
<tr>
<td width="30%"><b>🎨 Design Elements</b></td>
<td>
<b>Header Bar (Blue):</b> Displays application title, patient information (Kim Chi Zhou, Age 12, Male), and current date/time<br>
<b>Side Navigation Menu:</b> Clean white sidebar with 7 menu options for easy access to all features<br>
<b>Main Content Area:</b> Form-based interface with clear labels and input fields<br>
<b>Color Scheme:</b> Professional blue theme with white backgrounds for readability
</td>
</tr>
<tr>
<td><b>📝 Form Fields Explained</b></td>
<td>
<b>Medicine Name:</b> Text field for entering medication name (e.g., "Insulin")<br>
<b>Dosage:</b> Specifies amount per dose (e.g., "300mg")<br>
<b>Frequency:</b> How often to take medication (e.g., "12 hours")<br>
<b>Notes:</b> Optional field for special instructions (e.g., "after meal")<br>
<b>Start Date:</b> When treatment begins (DD/MM/YYYY format)<br>
<b>First Dose Time:</b> Exact time for first dose (HH:MM format)<br>
<b>Treatment Duration:</b> Number of days (0 = continuous)<br>
<b>Medicine Type:</b> Dropdown menu (Oral Medicine, Tablet, Capsule)
</td>
</tr>
<tr>
<td><b>🎯 Purpose</b></td>
<td>
Allows users to <b>create new prescriptions</b> with all necessary details in one centralized form. The interface guides users through each required field with clear labels and examples. Once submitted, the prescription is added to the system and automatically scheduled.
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• Validates all input fields before submission<br>
• Creates Medicine objects (OralMedicine, Tablet, or Capsule)<br>
• Calculates and schedules the first dose automatically<br>
• Provides immediate feedback with success message<br>
• Redirects to schedule view to show the new prescription
</td>
</tr>
</table>
...
#### **2. Success Dialog - Prescription Added**

<div align="center">

![Success Message](https://github.com/user-attachments/assets/8bbd27aa-abd9-4144-89a7-c86b2b17cc45)

</div>

<table>
<tr>
<td width="30%"><b>💬 Dialog Elements</b></td>
<td>
<b>Success Icon:</b> Blue information icon indicates successful operation<br>
<b>Message Title:</b> "Success" with blue header background<br>
<b>Confirmation Text:</b> "Prescription added successfully!"<br>
<b>Next Dose Info:</b> Displays calculated next dose time (06/12/2025 08:00)<br>
<b>OK Button:</b> Closes dialog and returns to main interface
</td>
</tr>
<tr>
<td><b>🎯 Purpose</b></td>
<td>
Provides <b>immediate visual feedback</b> that the prescription was successfully added to the system. Shows users the exact time of their first scheduled dose, confirming the system has processed their input correctly.
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• Confirms successful prescription creation<br>
• Displays the calculated first dose time<br>
• Reassures user that data was saved<br>
• Auto-dismisses when OK is clicked<br>
• Refreshes the schedule view with new data
</td>
</tr>
</table>
...
#### **3. Mark Dose Taken Screen**

<div align="center">

![Mark Dose Taken](https://github.com/user-attachments/assets/35b3f5ee-7477-4995-a5af-7e184661ee47)

</div>

<table>
<tr>
<td width="30%"><b>📋 Interface Components</b></td>
<td>
<b>Active Prescriptions List:</b> Shows only medicines that are currently active<br>
<b>Medicine Cards (Blue Background):</b><br>
  • <b>Insulin - 300mg</b> → Next: 06/12/2025 08:00<br>
  • <b>Paracetamol - 2 tablet</b> → Next: 06/12/2025 17:00<br>
<b>Selection System:</b> Click on a medicine to select it<br>
<b>Action Button:</b> "Mark as Taken & Calculate Next" button at bottom
</td>
</tr>
<tr>
<td><b>🎯 Purpose</b></td>
<td>
Enables users to <b>record when they've taken their medication</b>. The system automatically calculates the next dose time based on the medication's frequency, ensuring users never miss a dose and maintain consistent medication schedules.
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• Displays only active, non-completed prescriptions<br>
• Shows current next dose time for each medicine<br>
• Records the dose as taken when button is clicked<br>
• <b>Automatically calculates next dose</b> (e.g., 12 hours later)<br>
• Updates the schedule immediately<br>
• Shows success dialog with new next dose time<br>
• Demonstrates <b>polymorphism</b> - different medicine types handled uniformly
</td>
</tr>
</table>
...
#### **4. Dose Confirmation Dialog**

<div align="center">

![Dose Confirmation](https://github.com/user-attachments/assets/8bbd27aa-abd9-4144-89a7-c86b2b17cc45)

</div>

<table>
<tr>
<td width="30%"><b>💊 Confirmation Details</b></td>
<td>
<b>Success Message:</b> "Dose marked as taken!"<br>
<b>Next Dose Calculation:</b> Automatically computed based on frequency<br>
<b>Example:</b> If taken at 08:00 with 12-hour frequency → Next dose: 20:00<br>
<b>Real-time Update:</b> Schedule view refreshes to show new time
</td>
</tr>
<tr>
<td><b>🎯 Purpose</b></td>
<td>
Confirms dose was recorded and immediately shows when the user needs to take their next dose. This eliminates manual calculation and reduces the risk of taking medication too early or too late.
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• Records current timestamp for dose intake<br>
• Calls <code>calculateNextTime()</code> method (OOP abstraction)<br>
• Updates internal Medicine object state<br>
• Refreshes all views to show updated schedule<br>
...
#### **5. Manage Status Screen - After Completion**

<div align="center">

![Manage Status](https://github.com/user-attachments/assets/35b3f5ee-7477-4995-a5af-7e184661ee47)

</div>

<table>
<tr>
<td width="30%"><b>⚙️ Status Management</b></td>
<td>
<b>Prescription List:</b> Shows all medicines with current status<br>
<b>Status Indicators:</b><br>
  • <b>Paracetamol (2 tablet) [COMPLETED]</b> - Gray text (treatment finished)<br>
  • <b>Insulin (300mg) [ACTIVE]</b> - Green text (currently taking)<br>
<b>Control Buttons:</b><br>
  • Set Active (Blue) - Reactivate prescription<br>
  • Set Inactive (Blue) - Temporarily pause<br>
  • Set Completed (Blue) - Mark treatment finished<br>
  • Delete Prescription (Red) - Permanently remove
</td>
</tr>
<tr>
<td><b>🎯 Purpose</b></td>
<td>
Provides <b>complete lifecycle management</b> for prescriptions. Users can pause medications temporarily, mark treatments as completed, reactivate paused medications, or permanently delete prescriptions they no longer need. The visual status indicators make it easy to see the state of each prescription at a glance.
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• Displays all prescriptions with color-coded status<br>
• <b>Set Active:</b> Changes status to ACTIVE, makes medicine appear in dose tracking<br>
• <b>Set Inactive:</b> Pauses medicine (stays in system but not tracked)<br>
• <b>Set Completed:</b> Marks treatment finished, removes from active schedules<br>
• <b>Delete:</b> Permanently removes prescription with confirmation dialog<br>
• Uses <b>encapsulation</b> - status changes update internal state properly<br>
• Demonstrates <b>state management</b> - tracks medicine lifecycle
</td>
</tr>
</table>
...
#### **6. Status Update Confirmation**

<div align="center">

![Status Updated](https://github.com/user-attachments/assets/8bbd27aa-abd9-4144-89a7-c86b2b17cc45)

</div>

<table>
<tr>
<td width="30%"><b>✔️ Update Confirmation</b></td>
<td>
<b>Message:</b> "Status updated to COMPLETED: Paracetamol"<br>
<b>Effect:</b> Medicine no longer appears in active lists<br>
<b>Visual Change:</b> Status indicator changes to gray in all views<br>
<b>Schedule Impact:</b> Removed from "Mark Dose Taken" screen
</td>
</tr>
<tr>
<td><b>🎯 Purpose</b></td>
<td>
Confirms the status change was successfully applied. This is crucial for user confidence - they know the system has processed their request and the medicine's status has been updated throughout the entire application.
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• Updates Medicine object's <code>isCompleted</code> flag<br>
• Triggers <code>refreshAllPanels()</code> to update all views<br>
• Removes medicine from active prescription lists<br>
• Maintains medicine in system for historical records<br>
• Shows completed status in schedule and details views
</td>
</tr>
</table>
...
#### **7. Calculate Medicine Usage Screen**

<div align="center">

![Calculate Usage](https://github.com/user-attachments/assets/35b3f5ee-7477-4995-a5af-7e184661ee47)

</div>

<table>
<tr>
<td width="30%"><b>🧮 Calculation Interface</b></td>
<td>
<b>Medicine Selector:</b> Dropdown showing "Paracetamol (400mg)"<br>
<b>Days Input:</b> Field for continuous medications (12 days entered)<br>
<b>Run Calculation Button:</b> Triggers computation<br>
<b>Results Display Area:</b> Monospaced text showing detailed analysis:<br>
<pre>
...
<td><b>🎯 Purpose</b></td>
<td>
Helps users <b>plan their medication purchases</b> by calculating exactly how many doses they'll need for a given period. This is especially useful for:
<ul>
<li>Ordering the right quantity from pharmacy</li>
<li>Avoiding running out of medication mid-treatment</li>
<li>Budgeting for continuous medications</li>
<li>Ensuring adequate supply before vacations</li>
</ul>
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• <b>Parses frequency:</b> "9 hours" → calculates 24÷9 = 2.67 → 2 doses per day<br>
• <b>Multiplies:</b> 2 doses/day × 12 days = 24 total doses<br>
• <b>Displays formatted output:</b> Easy-to-read breakdown of calculation<br>
• <b>Handles continuous meds:</b> Prompts for days if duration = 0<br>
• <b>Validates input:</b> Checks frequency format, ensures positive numbers<br>
• <b>Error handling:</b> Shows clear messages if calculation fails<br>
<br>
<b>Example Math:</b><br>
Frequency "8 hours" → 24÷8 = 3 doses/day<br>
Frequency "1 day" → 1 dose/day<br>
Frequency "12 hours" → 24÷12 = 2 doses/day
</td>
</tr>
</table>
...
#### **8. View Prescription Details Screen**

<div align="center">

![Prescription Details](https://github.com/user-attachments/assets/35b3f5ee-7477-4995-a5af-7e184661ee47)

</div>

<table>
<tr>
<td width="30%"><b>📋 Details Interface</b></td>
<td>
<b>Left Panel (List):</b> Shows all prescriptions with status color<br>
  • Paracetamol [ACTIVE] - Green text<br>
  • Insulin [ACTIVE] - Green text<br>
<b>Right Panel (Details):</b> Complete information for selected medicine:<br>
<pre>
════════════════════════════════════════
   MEDICINE: PARACETAMOL
   TYPE: Capsule
...
<td><b>🎯 Purpose</b></td>
<td>
Provides a <b>comprehensive view</b> of all prescription information in one place. Users can quickly review:
<ul>
<li>Complete medication details</li>
<li>Current status and next dose</li>
<li>Treatment duration and remaining days</li>
<li>Special notes and instructions</li>
<li>Medicine type (affects how it's taken)</li>
</ul>
This is the "information hub" where users can verify all details of their medications.
</td>
</tr>
<tr>
<td><b>✅ What It Does</b></td>
<td>
• <b>Two-panel design:</b> List + Details (split pane interface)<br>
• <b>Click to view:</b> Select medicine from list → details appear on right<br>
• <b>Shows medicine type:</b> Oral Medicine, Tablet, or Capsule (polymorphism)<br>
• <b>Displays all fields:</b> Every piece of information entered by user<br>
• <b>Calculates remaining days:</b> For fixed-duration treatments<br>
• <b>Shows treatment period:</b> Start date, duration, days left<br>
• <b>Formats output:</b> Clean, monospaced, easy-to-read layout<br>
• <b>Real-time updates:</b> Changes immediately when prescriptions are modified<br>
<br>
<b>Data Flow:</b> Calls Medicine's <code>displayInfo()</code> method → Abstract class provides consistent formatting → Each medicine type (Tablet, Capsule, Oral) returns its type via <code>toString()</code> override
</td>
</tr>
</table>
...
<table>
<tr>
<td width="25%"><b>🎯 User Experience</b></td>
<td>
<b>Intuitive Navigation:</b> Side menu always visible, one click to any feature<br>
<b>Clear Visual Hierarchy:</b> Headers, sections, and buttons clearly distinguished<br>
<b>Immediate Feedback:</b> Success/error dialogs for every action<br>
<b>Consistent Layout:</b> Same structure across all screens reduces learning curve<br>
<b>Color-Coded Status:</b> Green (active), Red (overdue), Gray (completed)
</td>
</tr>
<tr>
<td><b>🛡️ Error Prevention</b></td>
<td>
<b>Input Validation:</b> Checks all fields before submission<br>
<b>Clear Labels:</b> Examples shown in placeholder text (e.g., "8 hours")<br>
<b>Confirmation Dialogs:</b> Critical actions like delete require confirmation<br>
<b>Dropdown Menus:</b> Limited choices prevent typos (Medicine Type)<br>
<b>Format Hints:</b> Date/Time formats clearly specified
</td>
</tr>
<tr>
<td><b>♿ Accessibility</b></td>
<td>
<b>Large Font Sizes:</b> 16px+ for readability<br>
<b>High Contrast:</b> Dark text on white/light backgrounds<br>
<b>Clear Buttons:</b> Large click targets (45px height)<br>
<b>Keyboard Navigation:</b> Tab between fields, Enter to submit<br>
<b>Monospaced Output:</b> Aligned calculations easy to read
</td>
</tr>
<tr>
<td><b>🎨 Visual Design</b></td>
<td>
<b>Professional Color Scheme:</b> Medical blue theme (#3498DB)<br>
<b>White Space:</b> Generous padding prevents visual clutter<br>
<b>Consistent Styling:</b> Same button styles, borders, fonts throughout<br>
<b>Hover Effects:</b> Buttons change color on mouseover for feedback<br>
<b>Border Highlighting:</b> Selected items stand out with color borders
</td>
</tr>
</table>
...
### 🔄 How GUI Implements OOP Concepts

<table>
<tr>
<td width="30%"><b>📦 Encapsulation</b></td>
<td>
<b>GUI Implementation:</b> All Medicine data is private - GUI accesses through getters<br>
<b>Example:</b> <code>med.getName()</code>, <code>med.getStatusDisplay()</code><br>
<b>Benefit:</b> GUI can't accidentally corrupt medicine data - controlled access only
</td>
</tr>
<tr>
<td><b>🔄 Polymorphism</b></td>
<td>
<b>GUI Implementation:</b> All medicines stored in <code>List&lt;Medicine&gt;</code><br>
<b>Example:</b> Same <code>take()</code> method call works for Tablet, Capsule, Oral<br>
<b>Benefit:</b> GUI doesn't need to know specific medicine type - treats all uniformly<br>
<b>Visual:</b> Details screen shows medicine type via <code>toString()</code> override
</td>
</tr>
<tr>
<td><b>🎭 Abstraction</b></td>
<td>
<b>GUI Implementation:</b> User clicks "Mark Taken" → system handles complex calculations<br>
<b>Example:</b> <code>calculateNextTime()</code> hides duration parsing, time math<br>
<b>Benefit:</b> User sees simple interface - complexity hidden in Medicine class
</td>
</tr>
<tr>
<td><b>🧬 Inheritance</b></td>
<td>
<b>GUI Implementation:</b> Dropdown creates OralMedicine, Tablet, or Capsule objects<br>
<b>Example:</b> All three types inherit <code>calculateNextTime()</code>, <code>displayInfo()</code><br>
<b>Benefit:</b> Code reuse - each type only implements unique <code>take()</code> behavior
</td>
</tr>
</table>
...
![Console View](https://github.com/user-attachments/assets/35b3f5ee-7477-4995-a5af-7e184661ee47)

*Figure: Console-based interface showing medication tracking and schedule management*
